...
train_data.columns = [
    'date', 'day', 'employees','day_off', 'business_trip', 
    'overtime', 'telecommuting', 'breakfast', 'lunch', 
    'dinner', 'num_lunch', 'num_dinner'
]
test_data.columns = [
    'date', 'day', 'employees','day_off', 'business_trip', 
    'overtime', 'telecommuting', 'breakfast', 'lunch', 'dinner'
]
# %%
...
features = [
    'employees','day_off', 'business_trip', 'overtime', 
    'employees','day_off', 'business_trip', 'overtime'
]
...
corr_data = train_data[
    [
        'num_lunch', 'num_dinner', 'employees','day_off', 
        'business_trip', 'overtime', 'telecommuting'
    ]
]
